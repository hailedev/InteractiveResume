            ...
            return [
                {
                    ...
                    response: "<p style=\"font-size:14px;line-height:20px\">..This is often difficult for me to articulate.  To me, it would actually be akin to asking why you would want to work aboard the starship Enterprise.  But to put it simply, I love Blizzard games.  I am passionate about them.  The addictive gameplay, the high standards in production quality, the presentation, from artwork, sound, cinematics, design, development, QA and even community engagement these are things that I truly admire about Blizzard games and Blizzard as a company.  <br/><br/>To be able to be a part of that pedigree and to contribute in some way to the games I love and those of which have given me so much joy over many years, it would honestly be a dream come true for me. </p>"
                },
                {
                ...
                {
                    question: "<p style=\"font-weight:bold;\">Horde or Alliance?</p>",
                    response: "<span style=\"font-weight:bold;color:red;background:black;padding: 0 15px 0 15px;\">FOR THE HORDE!!!!!</span>" +
                    "<p style=\"font-size:14px;line-height:20px\">Thank you so much for taking the time to read/play through my application.  <br/>If you would like to get in touch with me, you can do so through this link <a href=\"http://haile.info/contact\" target=\"_blank\">here</a> " +
                    "or feel free to use one of my social media links.  I hope to speak to you soon (real soon, not soon&#8482;).<br/><br/>" +
